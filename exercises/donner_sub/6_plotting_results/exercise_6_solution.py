...
phase = dm.Phase(ode_class=DonnerSubODE,
                 transcription=dm.GaussLobatto(num_segments=30, order=3, compressed=False))
...
#
# Add additional timeseries outputs here
#
phase.add_timeseries_output('nav_comp.r_ship2', shape=(1,))
phase.add_timeseries_output('threat_comp.sub_range', shape=(1,))

phase.add_objective(name='v', loc='initial')

phase.refine_options['refine'] = True
phase.refine_options['tolerance'] = 1.0E-6
...
p.set_val('traj.phase0.t_duration', value=2.0)
