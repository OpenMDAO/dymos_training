...
phase0 = dm.Phase(ode_class=DonnerSubODE,
                  transcription=dm.GaussLobatto(num_segments=10, order=3, compressed=True, solve_segments=True))

phase1 = dm.Phase(ode_class=DonnerSubODE,
                  transcription=dm.Radau(num_segments=10, order=3, compressed=True, solve_segments=True))
